...
async def refresh_joke(_, query):
    ...
    await query.message.edit_text(new_joke_text , reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("ʀᴇғʀᴇsʜ", callback_data=f"refresh_joke")]]),parse_mode=ParseMode.HTML)