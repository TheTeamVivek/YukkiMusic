...
async def deletechatphoto(_, message):
      ...
      try:
         if admin_check.privileges.can_change_info:
             ...
             await msg.edit("**ɢʀᴏᴜᴘs  ᴘʀᴏғɪʟᴇ ᴘʜᴏᴛᴏ ʀᴇᴍᴏᴠᴇᴅ  !\nʙʏ** {}".format(message.from_user.mention))    
      except:
      ...
      if message.chat.type == enums.ChatType.PRIVATE:
          ...
          try:
             if admin_check.privileges.can_change_info:
                ...
                await msg.edit_text("**ɴᴇᴡ ɢʀᴏᴜᴘ ᴘʀᴏғɪʟᴇ ᴘʜᴏᴛᴏ ᴄʜᴀɴɢᴇᴅ !\nʙʏ** {}".format(message.from_user.mention))
             else:
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
          ...
          try:
            ...
            if admin_check.privileges.can_change_info:
               ...
               await msg.edit("**ɴᴇᴡ ɢʀᴏᴜᴘ ɴᴀᴍᴇ ᴄʜᴀɴɢᴇᴅ !\nʙʏ** {}".format(message.from_user.mention))
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        try:
            ...
            if admin_check.privileges.can_change_info:
                ...
                await msg.edit("**ɴᴇᴡ ᴅɪsᴄʀɪᴘᴛɪᴏɴ ᴏғ ɢʀᴏᴜᴘ ᴄʜᴀɴɢᴇᴅ!**\nʙʏ {}".format(message.from_user.mention))
        except AttributeError:
