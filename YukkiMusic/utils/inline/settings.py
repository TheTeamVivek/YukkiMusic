...
def cleanmode_settings_markup(
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text=_["ST_B_28"], callback_data="COMMANDANSWER"
            ),
            InlineKeyboardButton(
        ...
        [
            InlineKeyboardButton(
                text=_["ST_B_29"], callback_data="SUGGANSWER"
            ),
            InlineKeyboardButton(
                text=_["ST_B_16"] if sug == True else _["ST_B_17"],
...
def auth_users_markup(_, status: Union[bool, str] = None):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text=_["ST_B_20"], callback_data="AUTHLIST"
            ),
        ],
        [
            InlineKeyboardButton(
...
def playmode_users_markup(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text=_["ST_B_21"], callback_data="SEARCHANSWER"
            ),
            InlineKeyboardButton(
                text=_["ST_B_22"] if Direct == True else _["ST_B_23"],
                callback_data="MODECHANGE",
            ),
        ],
        [
            InlineKeyboardButton(
                text=_["ST_B_24"], callback_data="AUTHANSWER"
            ),
            InlineKeyboardButton(
                text=_["ST_B_18"] if Group == True else _["ST_B_19"],
                callback_data="CHANNELMODECHANGE",
            ),
        ],
        [
            InlineKeyboardButton(
                text=_["ST_B_27"], callback_data="PLAYTYPEANSWER"
            ),
            InlineKeyboardButton(
                text=_["ST_B_18"]
                if Playtype == True
