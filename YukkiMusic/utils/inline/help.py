    ...
    firsts_page = InlineKeyboardMarkup(
        [
            ...
            [
                ...
                InlineKeyboardButton(
                    text=_["H_B_9"], callback_data="help_callback hb8"
                ),
                InlineKeyboardButton(
                    text=_["H_B_8"], callback_data="help_callback hb7"
                ),
            ],
            [
                InlineKeyboardButton(
                ...
                InlineKeyboardButton(
                    text=_["H_B_10"], callback_data="help_callback hb9"
                ),
                InlineKeyboardButton(
                    text=_["H_B_7"], callback_data="help_callback hb6"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_["H_B_6"], callback_data="help_callback hb5"
                ),
                InlineKeyboardButton(
