    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "*ɴᴏ ᴀᴄᴛɪᴠᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ғᴏᴜɴᴅ**\n\nᴘʟᴇᴀsᴇ ᴍᴀᴋᴇ sᴜʀᴇ ɢʀᴏᴜᴘ's ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ɪs ᴇɴᴀʙʟᴇᴅ. ɪғ ᴀʟʀᴇᴀᴅʏ ᴇɴᴀʙʟᴇᴅ, ᴘʟᴇᴀsᴇ ᴇɴᴅ ɪᴛ ᴀɴᴅ sᴛᴀʀᴛ ғʀᴇsʜ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɢᴀɪɴɢ ɪғ ᴛʜᴇ ᴘʀᴏʙʟᴇᴍ ᴄᴏɴᴛɪɴᴜᴇs, ᴛʀʏ /reboot"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**Assɪsᴛᴀɴᴛ Aʟʀᴇᴀᴅʏ ɪɴ Vᴏɪᴄᴇ Cʜᴀᴛ**\n\nSʏsᴛᴇᴍs ʜᴀᴠᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ ᴛʜᴀᴛ ᴀssɪsᴛᴀɴᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴛʜᴇʀᴇ ɪɴ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ, ᴛʜɪs ɪssᴜᴇ ɢᴇɴᴇʀᴀʟʟʏ ᴄᴏᴍᴇs ᴡʜᴇɴ ʏᴏᴜ ᴘʟᴀʏ 𝟸 ǫᴜᴇʀɪᴇs ᴛᴏɢᴇᴛʜᴇʀ.\n\nIғ ᴀssɪsᴛᴀɴᴛ ɪs ɴᴏᴛ ᴘʀᴇsᴇɴᴛ ɪɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ, ᴘʟᴇᴀsᴇ ᴇɴᴅ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɴᴅ sᴛᴀʀᴛ ғʀᴇsʜ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɢᴀɪɴ ᴀɴᴅ ɪғ ᴛʜᴇ  ᴘʀᴏʙʟᴇᴍ ᴄᴏɴᴛɪɴᴜᴇs, ᴛʀʏ /reboot"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**Tᴇʟᴇɢʀᴀᴍ Sᴇʀᴠᴇʀ Eʀʀᴏʀ**\n\nTᴇʟᴇɢʀᴀᴍ ɪs ʜᴀᴠɪɴɢ sᴏᴍᴇ ɪɴᴛᴇʀɴᴀʟ sᴇʀᴠᴇʀ ᴘʀᴏʙʟᴇᴍs, Pʟᴇᴀsᴇ ᴛʀʏ ᴘʟᴀʏɪɴɢ ᴀɢᴀɪɴ.\n\n Iғ ᴛʜɪs ᴘʀᴏʙʟᴇᴍ ᴋᴇᴇᴘs ᴄᴏᴍɪɴɢ ᴇᴠᴇʀʏᴛɪᴍᴇ, ᴘʟᴇᴀsᴇ ᴇɴᴅ ʏᴏᴜʀ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɴᴅ sᴛᴀʀᴛ ғʀᴇsʜ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɢᴀɪɴ."
            )
