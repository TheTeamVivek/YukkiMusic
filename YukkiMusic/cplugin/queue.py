...
@Client.on_message(filters.command(QUEUE_COMMAND) & filters.group & ~BANNED_USERS)
@language
...
@Client.on_callback_query(filters.regex("GetTimer") & ~BANNED_USERS)
...
@Client.on_callback_query(filters.regex("GetQueued") & ~BANNED_USERS)
@languageCB
...
@Client.on_callback_query(filters.regex("queue_back_timer") & ~BANNED_USERS)
@languageCB
